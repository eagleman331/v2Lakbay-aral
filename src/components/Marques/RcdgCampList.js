...
export const RcdgCampList = ({ item }) => {
    ...
    >
      <Animated.View
        ...
        <View className="mt-4 w-3/5">
          <Text className="ml-4 text-lg font-bold text-slate-950 antialiased">1301 CDC</Text>
          <Text className="ml-4 text-wrap text-base antialiased">Areas: Marikina, Mandaluyong and Pasig </Text>
        </View>
